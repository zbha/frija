!(function(t, e) {
  ...
  (function() {
    function t(t, e, o, s) {
      ...
      if (((i[e] || (i[e] = [])).push(c), r[e]))
        for (t = 0, c = [c]; (o = r[e][t++]) && (n(0, 0, o[0], o[1], c), !s); );
    }
    function e(t, e, n) {
      var o = 0;
      if ((toSubs = i[e]))
        for (; (e = toSubs[o++]); )
          e[0] !== t || (n && n !== e[1]) || toSubs.splice(--o, 1);
    }
        ...
        var n =
          ...
          s = (i.WordArray = r.extend({
            ...
            concat: function(t) {
              ...
              else for (var r = 0; r < i; r += 4) e[(o + r) >>> 2] = n[r >>> 2];
  ...
  (function(t, e) {
    "object" == typeof exports
      ...
      : "function" == typeof define && define.amd
      ? define("crypto-js/enc-base64", ["./core"], e)
      : e(t.CryptoJS);
  })(this, function(t) {
    return (
      (function() {
            ...
            for (var i = [], r = 0; r < n; r += 3)
              for (
                var s = (e[r >>> 2] >>> (24 - (r % 4) * 8)) & 255,
                  c = (e[(r + 1) >>> 2] >>> (24 - ((r + 1) % 4) * 8)) & 255,
                  a = (e[(r + 2) >>> 2] >>> (24 - ((r + 2) % 4) * 8)) & 255,
                  u = (s << 16) | (c << 8) | a,
                  f = 0;
                f < 4 && r + 0.75 * f < n;
                f++
              )
                i.push(o.charAt((u >>> (6 * (3 - f))) & 63));
            var d = o.charAt(64);
        ...
        var l = (f.MD5 = u.extend({
          ...
          _doProcessBlock: function(t, e) {
            ...
            var u = this._hash.words,
              ...
              H = u[3];
            (C = n(C, j, E, H, f, 7, d[0])),
              (H = n(H, C, j, E, l, 12, d[1])),
              (E = n(E, H, C, j, m, 17, d[2])),
              (j = n(j, E, H, C, p, 22, d[3])),
              (C = n(C, j, E, H, h, 7, d[4])),
              (H = n(H, C, j, E, g, 12, d[5])),
              (E = n(E, H, C, j, y, 17, d[6])),
              (j = n(j, E, H, C, v, 22, d[7])),
              (C = n(C, j, E, H, _, 7, d[8])),
              (H = n(H, C, j, E, k, 12, d[9])),
              (E = n(E, H, C, j, w, 17, d[10])),
              (j = n(j, E, H, C, x, 22, d[11])),
              (C = n(C, j, E, H, b, 7, d[12])),
              (H = n(H, C, j, E, S, 12, d[13])),
              (E = n(E, H, C, j, B, 17, d[14])),
              (j = n(j, E, H, C, A, 22, d[15])),
              (C = o(C, j, E, H, l, 5, d[16])),
              (H = o(H, C, j, E, y, 9, d[17])),
              (E = o(E, H, C, j, x, 14, d[18])),
              (j = o(j, E, H, C, f, 20, d[19])),
              (C = o(C, j, E, H, g, 5, d[20])),
              (H = o(H, C, j, E, w, 9, d[21])),
              (E = o(E, H, C, j, A, 14, d[22])),
              (j = o(j, E, H, C, h, 20, d[23])),
              (C = o(C, j, E, H, k, 5, d[24])),
              (H = o(H, C, j, E, B, 9, d[25])),
              (E = o(E, H, C, j, p, 14, d[26])),
              (j = o(j, E, H, C, _, 20, d[27])),
              (C = o(C, j, E, H, S, 5, d[28])),
              (H = o(H, C, j, E, m, 9, d[29])),
              (E = o(E, H, C, j, v, 14, d[30])),
              (j = o(j, E, H, C, b, 20, d[31])),
              (C = i(C, j, E, H, g, 4, d[32])),
              (H = i(H, C, j, E, _, 11, d[33])),
              (E = i(E, H, C, j, x, 16, d[34])),
              (j = i(j, E, H, C, B, 23, d[35])),
              (C = i(C, j, E, H, l, 4, d[36])),
              (H = i(H, C, j, E, h, 11, d[37])),
              (E = i(E, H, C, j, v, 16, d[38])),
              (j = i(j, E, H, C, w, 23, d[39])),
              (C = i(C, j, E, H, S, 4, d[40])),
              (H = i(H, C, j, E, f, 11, d[41])),
              (E = i(E, H, C, j, p, 16, d[42])),
              (j = i(j, E, H, C, y, 23, d[43])),
              (C = i(C, j, E, H, k, 4, d[44])),
              (H = i(H, C, j, E, b, 11, d[45])),
              (E = i(E, H, C, j, A, 16, d[46])),
              (j = i(j, E, H, C, m, 23, d[47])),
              (C = r(C, j, E, H, f, 6, d[48])),
              (H = r(H, C, j, E, v, 10, d[49])),
              (E = r(E, H, C, j, B, 15, d[50])),
              (j = r(j, E, H, C, g, 21, d[51])),
              (C = r(C, j, E, H, b, 6, d[52])),
              (H = r(H, C, j, E, p, 10, d[53])),
              (E = r(E, H, C, j, w, 15, d[54])),
              (j = r(j, E, H, C, l, 21, d[55])),
              (C = r(C, j, E, H, _, 6, d[56])),
              (H = r(H, C, j, E, A, 10, d[57])),
              (E = r(E, H, C, j, y, 15, d[58])),
              (j = r(j, E, H, C, S, 21, d[59])),
              (C = r(C, j, E, H, h, 6, d[60])),
              (H = r(H, C, j, E, x, 10, d[61])),
              (E = r(E, H, C, j, m, 15, d[62])),
              (j = r(j, E, H, C, k, 21, d[63])),
              (u[0] = (u[0] + C) | 0),
              (u[1] = (u[1] + j) | 0),
              (u[2] = (u[2] + E) | 0),
              (u[3] = (u[3] + H) | 0);
  ...
  (function(t, e, n) {
    "object" == typeof exports
      ...
      : "function" == typeof define && define.amd
      ? define("crypto-js/evpkdf", ["./core", "./sha1", "./hmac"], e)
      : e(t.CryptoJS);
  })(this, function(t) {
    return (
      (function() {
  ...
  (function(t, e, n) {
    "object" == typeof exports
      ? (module.exports = exports = e(require("./core"), require("./evpkdf")))
      : "function" == typeof define && define.amd
      ? define("crypto-js/cipher-core", ["./core", "./evpkdf"], e)
      : e(t.CryptoJS);
  })(this, function(t) {
    t.lib.Cipher ||
      (function(e) {
        var n = t,
            ...
            ((o.BlockCipher = d.extend({
              ...
              reset: function() {
                ...
                this._mode && this._mode.__creator == o
                  ...
                  : ((this._mode = o.call(n, this, e && e.words)),
          ...
          _ = (v.OpenSSL = {
            ...
            parse: function(t) {
              ...
              return y.create({ ciphertext: e, salt: o });
            }
          }),
          ...
          x = (w.OpenSSL = {
            execute: function(t, e, n, o) {
              o || (o = r.random(8));
              var i = f.create({ keySize: e + n }).compute(t, o),
                s = r.create(i.words.slice(e), 4 * n);
              return (i.sigBytes = 4 * e), y.create({ key: i, iv: s, salt: o });
            }
          }),
        ...
        var h = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54],
          g = (i.AES = o.extend({
            ...
            decryptBlock: function(t, e) {
              ...
              (t[e + 1] = t[e + 3]),
                (t[e + 3] = n),
                this._doCryptBlock(t, e, this._invKeySchedule, d, l, m, p, s);
              var n = t[e + 1];
              (t[e + 1] = t[e + 3]), (t[e + 3] = n);
            },
  ...
  (function(t, e) {
    "object" == typeof exports
      ? (module.exports = exports = e(require("./core")))
      : "function" == typeof define && define.amd
      ? define("crypto-js/enc-utf8", ["./core"], e)
      : e(t.CryptoJS);
  })(this, function(t) {
    return t.enc.Utf8;
  }),
  ...
  define("settings", {
    ...
    motd:
      "<pre>\n\n▄█████▒██▀███   ██▓ ▄▄▄██▀▀▀▄▄▄  \n▒▓██   ▒▓██ ▒ ██▒▓██▒   ▒██  ▒████▄  \n▒▒████ ░▓██ ░▄█ ▒▒██▒   ░██  ▒██  ▀█▄    \n▒░▓█▒  ░▒██▀▀█▄  ░██░▓██▄██▓ ░██▄▄▄▄██   \n░▒█░   ░██▓ ▒██▒░██░ ▓███▒   ▓█   ▓██▒ \n ▒ ░   ░ ▒▓ ░▒▓░░▓   ▒▓▒▒░   ▒▒   ▓▒█░ \n  ░       ░▒ ░ ▒░ ▒ ░ ▒ ░▒░    ▒   ▒▒ ░ \n ░ ░     ░░   ░  ▒ ░ ░ ░ ░    ░   ▒     \n          ░      ░   ░   ░        ░  ░    \n                                                                    \n Tip of the day: /help                                                \n---------------------------------------</pre>",
    nick: { maxLen: 20, minLen: 2 },
    key: { maxLen: 1024, minLen: 8 },
    room: { minLen: 1, maxLen: 64 },
    notifications: { maxOnePerMs: 3e3 }
  }),
  define("templates", {
    help:
    ...
    post: {
      ...
      info:
        '<li id="{id}"><i class="timestamp">[{timestamp}] </i>INF&gt; <i class="info">{text}</i></li>',
      server:
        '<li id="{id}"><i class="timestamp">[{timestamp}] </i>SRV&gt; <i class="server">{text}</i></li>',
      error:
        '<li id="{id}"><i class="timestamp">[{timestamp}] </i>ERR&gt; <i class="error">{text}</i></li>',
      message:
        '<li id="{id}"><i class="timestamp">[{timestamp}] </i>MSG&gt; <i class="nick">{nick}&gt;</i> <i class="message">{text}</i></li>'
    },
    messages: {
      ...
      nick_to_short:
        "Nickname is too short, it has to be at least {nick_minLen} characters long. Try again.",
      nick_to_long:
        "Nickname is too long, it can be at most {nick_maxLen} characters long. Try again.",
      nick_set: "From now on, you're referred to as '{nick}'.",
      msg_no_room:
        "You have to join a room before sending messages. See /help.",
      not_in_room: "You have to be in a room to count participants...",
      msg_no_key:
        "You have to set an encryption key before sending a message. See /help.",
      ...
      unable_to_decrypt:
        "Unabled to decrypt received message, keys does not match.",
      socket_error:
        "A network error has occurred. A restart may be required to bring back full functionality.<br>Examine the logs for more details.",
      connecting: "Connecting to host {host}...",
      connected:
        "A connection to the server has been established. Happy chatting!",
      disconnected: "Disconnected from host {host}.",
      already_connected:
        "You have to disconnect from {host} before joining another.",
      reconnect_no_host: "There is no host to reconnect with.",
      host_available:
        '<span class="info">{index}</span>\t<span class="good">[AVAILABLE]</span>\t<span class="neutral">{name}</span>\n',
      host_unavailable:
        '<span class="info">{index}</span>\t<span class="bad">[UNAVAILABLE]</span>\t<span class="neutral">{name}</span>\n'
    },
    server: {
      ...
      command_failed:
        "Server command failed, you're probably trying to du something bogus.",
      bogus: "Received a bogus message from server."
    },
    client: { title: "Cryptalk - Offline" }
  }),
  define("hosts", {
    autoconnect: 0,
    hosts: [{ name: "default", host: "", path: "/js/lib/settings.js" }]
  }),
    ...
    return (
      ...
      window.addEventListener
        ? (window.addEventListener("focus", n, !0),
          window.addEventListener("blur", o, !0))
        : (window.observe("focusin", n), window.observe("focusout", o)),
      t.on("window:title", e.setTitle),
      e
    );
  }),
  define("host", [
    ...
    var r,
        ...
        var s,
          ...
          f = function(n, i, s) {
            return function(c) {
              (n.settings = s ? c : 0),
                (u += t.template(
                  o.messages[s ? "host_available" : "host_unavailable"],
                  { name: n.name, path: n.path, index: i }
                )),
                0 === --a && (e.emit("console:info", u), r());
            };
          };
        for (n = n && "force" === n.toLowerCase(); (s = i.hosts[c]); )
          n || void 0 === s.settings
            ? require([s.path], f(s, c, 1), f(s, c, 0))
            : s.settings
            ? f(s, c, 1)()
            : f(s, c, 0)(),
            c++;
      ...
      d = function(a, u) {
        ...
        var f;
        if (((a = void 0 === a ? i.autoconnect : a), s && s.connected))
          return (
            e.emit(
              "console:error",
              t.template(o.messages.already_connected, {
        ...
        if (t.isDigits(a)) {
          if (!(s = i.hosts[+a]))
            return (
              e.emit("console:error", "Undefined host index: " + a),
              void e.emit("console:unlockInput")
            );
          s.settings ? (n = s.settings) : (f = s.path);
        } else a ? (f = a.settings) : (n = a.settings);
        return f
          ? require([f], function(t) {
              return (s.settings = t), d(a, u);
            }, function() {
              e.emit("console:error", "Could not fetch host settings: " + f),
                e.emit("console:unlockInput");
            })
          : (e.emit(
              "console:info",
              t.template(o.messages.connecting, { host: s.name || "localhost" })
            ),
            e.emit("console:motd", s.settings.motd),
            (r = t.io(s.host, { forceNew: !0, "force new connection": !0 })),
            void r
              .on("room:joined", function() {
                e.emit(
                  "console:info",
                  t.template(o.messages.joined_room, {
              ...
              .on("room:left", function() {
                e.emit(
                  "console:info",
                  t.template(o.messages.left_room, {
                    roomName: t.escapeHtml(c.room)
                  })
                ),
              ...
              .on("message:send", function(n) {
                var i = t.AES.decrypt(n.msg, t.SHA1(c.room) + c.key),
                  ...
                  s = n.nick
                    ? t.escapeHtml(
                        t.AES.decrypt(n.nick, t.SHA1(c.room) + c.key)
                      )
                    : o.default_nick;
                i
                  ? e.emit("console:message", { message: r, nick: s })
                ...
                if (n.msg) {
                  ...
                  if (o.server[i])
                    if (void 0 !== n.payload) {
                      ...
                      e.emit(
                        "console:server",
                        t.template(o.server[i], { payload: r })
                      );
              ...
              .on("connect", function() {
                e.emit(
                  "console:info",
                  t.template(o.messages.connected, {
                    host: s.name || "localhost"
                  })
                ),
                  e.emit("window:title", s.settings.title),
                  e.emit("console:unlockInput"),
                  u(),
                  (s.connected = 1);
              })
              .on("disconnect", function() {
                (s.connected = 0),
                  e.emit(
                    "console:info",
                    t.template(o.messages.disconnected, {
                      host: s.name || "localhost"
                    })
                  ),
                  e.emit("room:changed", void 0),
                  e.emit("window:title", o.client.title);
              })
              .on("connect_error", function() {
                (s.connected = 0),
                  e.emit("console:error", o.messages.socket_error),
                  e.emit("console:unlockInput");
              }));
      },
      l = function(t, n) {
        return s
          ? void (s.connected ? (m(), d(s, n)) : d(s, n))
          : (n(), e.emit("console:error", o.messages.reconnect_no_host));
      },
      m = function() {
        r.disconnect();
      },
    ...
    e.on("command:host", u),
      e.on("command:hosts", f),
      e.on("command:connect", d),
      e.on("command:disconnect", m),
      e.on("command:reconnect", l),
      e.on("socket:emit", a),
      e.on("host:param", p);
  }),
  define("client", ["$", "castrato", "settings", "templates"], function(
    t,
    e,
    n,
    o
    ...
    var i,
      r,
      s = function(t) {
        return t.length > n.key.maxLen
          ? e.emit("console:error", o.messages.key_to_long)
          : t.length < n.key.minLen
          ? e.emit("console:error", o.messages.key_to_short)
          : ((r = t),
            e.emit("key:changed", r),
            e.emit("console:info", o.messages.key_ok));
      },
      c = function() {
      ...
      f = function(r) {
        return r.length > n.nick.maxLen
          ? e(
              "console:error",
              t.template(o.messages.nick_to_long, {
                nick_maxLen: n.nick.maxLen
              })
            )
          : r.length < n.nick.minLen
          ? e(
              "console:error",
              t.template(o.messages.nick_to_short, {
                nick_minLen: n.nick.minLen
              })
            )
          : ((i = r),
            e.emit("nick:changed", i),
            void e.emit(
              "console:info",
              t.template(o.messages.nick_set, { nick: t.escapeHtml(i) })
            ));
      },
      d = function(n) {
        e.emit("window:title", n),
          e.emit(
            "console:info",
            t.template(o.messages.title_set, { title: t.escapeHtml(n) })
          );
      };
    e.on("command:help", c),
      e.on("command:clear", a),
      e.on("command:nick", f),
      e.on("command:key", s),
      e.on("command:torch", u),
  ...
  define("room", ["$", "castrato", "settings", "templates"], function(
    t,
    e,
    n,
    o
    ...
    var i = !1,
      r = function(r) {
        i !== !1
          ? e.emit(
              "console:error",
              t.template(o.messages.already_in_room, { room: i })
            )
          : r.length >= n.room.maxLen
          ? e.emit("console:error", t.template(o.messages.room_name_too_long))
          : r.length < n.room.minLen
          ? e.emit("console:error", t.template(o.messages.room_name_too_short))
          : ((i = r),
            e
              .emit("room:changed", i)
              .emit("socket:emit", { data: "room:join", payload: t.SHA1(i) }));
      },
      s = function() {
        i !== !1
          ? (e.emit("socket:emit", { data: "room:leave", payload: t.SHA1(i) }),
            (i = !1))
          : e.emit("console:error", o.messages.leave_from_nowhere);
      },
      c = function() {
        i
          ? e.emit("socket:emit", { data: "room:count" })
          : e.emit("console:error", o.messages.not_in_room);
      };
    e.on("command:join", r), e.on("command:leave", s), e.on("command:count", c);
  }),
  define("notifications", ["castrato", "window", "settings"], function(
    t,
    e,
    n
  ) {
    var o,
      ...
      m = function() {
        clearTimeout(r),
          void 0 !== i && e.setTitle(i),
          (i = void 0),
          (o = void 0);
      },
      p = function() {
        a
          ? (e.getTitle() === i ? e.setTitle(o) : e.setTitle(i),
            (r = setTimeout(p, s)))
          : m();
      },
      h = function() {
      ...
      g = function(t, n) {
        (s = void 0 === n ? 1e3 : n),
          a && void 0 === i && ((o = t), (i = e.getTitle()), p());
      },
      y = function(t, e, o, i) {
        if (a && f() - c > n.notifications.maxOnePerMs)
          if (
            (void 0 === i && (i = !1),
            u && "granted" === Notification.permission)
          ) {
            var r = new Notification(t, { body: e, icon: o });
            (r.onshow = function() {
              setTimeout(function() {
                r.close();
              }, 3e3);
    ...
    (u = void 0 !== window.Notification),
      t.on("notification:send", function(t) {
  ...
  define("queue", [], function() {
    ...
    return (
      (t.add_function_delayed = function(t, o, i) {
        e.push({ func: o, pushed: n(), delay: t, data: i });
      }),
      (t.get = function() {
        return e;
      }),
      (t.run = function() {
        for (var o, i, r = 0; (o = e[r++]); )
          n() - o.pushed > o.delay && (o.func(), e.splice(r - 1, 1));
        if (e.length) {
          for (i = n(); n() - i < 1; );
          t.run();
        }
      ...
      s = function(e, n) {
        if (
          ...
          (d.frequency.value = a),
            ...
            t.add_function_delayed(u, function() {
            ...
            n++,
            n < Object.keys(e).length ? s(e, n) : t.run();
        }
      },
      c = function() {
        i = !0;
  ...
  define("console", [
    ...
    var r = {
      ...
      c = {
        post: function(e, i, s) {
          ...
          (d.text = t.template(i, d)),
            (a = t.template(u, d)),
            c.showNotification(e, s, i),
            setTimeout(function() {
              var e = r.chat.first(),
                n = t("#" + f).first();
              e.removeChild(n);
        ...
        torch: function(i) {
          (i = parseInt(i)),
            i > 0 && i < 3600
              ? (e.emit(
                  "console:info",
                  t.template(o.messages.torch_is_now, { ttl: i })
                ),
                (n.ttl = 1e3 * i))
              : e.emit("console:error", t.template(o.messages.torch_not_set));
        },
        param: function(t) {
          s = Object.assign({}, s, t);
        },
        showNotification: function(t, n, o) {
          var r = "message" !== t ? "Cryptalk" : n,
            s =
              "message" === t
                ? "gfx/icon_128x128.png"
                : "error" === t
                ? "gfx/icon_128x128_error.png"
                : "gfx/icon_128x128_info.png";
        ...
        lockInput: function() {
          r.input[0].setAttribute("disabled", "disabled"),
            (r.inputWrapper[0].className = "loading");
        },
        unlockInput: function() {
          r.input[0].removeAttribute("disabled"),
            (r.inputWrapper[0].className = ""),
            r.input.focus();
        },
        _require: function(t, e) {
          c.lockInput(),
            c.post("info", "Requiring " + t + "..."),
            require([t], function() {
              c.post("info", "Successfully required " + t + "."),
                c.unlockInput(),
                e();
            }, function(n) {
              c.post(
                "error",
                'An error occurred while trying to load "' + t + '":\n' + n
              ),
                c.unlockInput(),
                e();
            });
      ...
      a = function(n) {
        var i, a, u, f;
        if (!n.ctrlKey && !n.altKey && r.input[0] !== t.activeElement())
          return r.input.focus();
        if (13 === n.keyCode && (i = r.input[0].value))
          if ("/" === (i[0] || i.slice(0, 1)))
            (a = t.ssplit(i.slice(1), " ")),
              (f = a[0]),
              (u = a[1]),
              e.emit("command:" + f, u, function(e, n) {
                return n
                  ? void c.clearInput()
                  : c.post(
                      "error",
                      t.template(o.messages.unrecognized_command, {
                        commandName: f
                      })
                    );
              });
            ...
            if (!s.room || !s.key)
              return s.room
                ? c.post("error", o.messages.msg_no_key)
                : c.post("error", o.messages.msg_no_room);
            e.emit("socket:emit", {
              data: "message:send",
              payload: {
                room: t.SHA1(s.room),
                ...
                nick:
                  !!s.nick &&
                  t.AES.encrypt(s.nick, t.SHA1(s.room) + s.key).toString()
              }
            }),
              c.clearInput();
          }
    ...
    for (var u in c)
      "_require" !== u && "post" !== u && e.on("console:" + u, c[u]);
    e.on("console:require", c._require),
      e.on("console:post", function(t) {
        c.post(t.type, t.data, t.nick);
      });
  }),
  define("cryptalk", ["castrato", "host", "client", "console"], function(t) {
    t.on("window:focused", function() {
      ...
      .on("room:changed", function(e) {
        t.emit("console:param", { room: e }).emit("host:param", { room: e });
      })
      .on("nick:changed", function(e) {
        t.emit("console:param", { nick: e });
      })
      .on("key:changed", function(e) {
        t.emit("console:param", { key: e }).emit("host:param", { key: e });
      })
      .emit("command:connect", void 0, function() {
        (hash = window.location.hash) &&
          ((parts = hash.slice(1).split(":")),
          parts[0] && t.emit("command:join", parts[0]),
          parts[1] && t.emit("command:key", parts[1]));
      });
  }),
  require.config({
    baseUrl: "js/lib/",
    paths: { websocket: "/socket.io/socket.io" },
    packages: [
      {
        name: "crypto-js",
      ...
      { name: "castrato", location: "../vendor/castrato", main: "castrato" }
    ]
  }),
  require(["cryptalk"]),
